...
/// Dummy ARAnchor class definition for compatibility
class ARAnchor {
  final String name;
  ARAnchor(this.name);
}
...
class ARSessionManager {
  ...
  void Function(int planeCount)? onPlaneDetected;
  ...
  /// Function to initialize the platform-specific AR view.
  onInitialize({
  ...
  /// Dispose the AR view on the platforms
  dispose() async {
    try {
